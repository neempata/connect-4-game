...
# import pygame and initialize the game
# Set up the game window(width and height)
# Set up 2 colors for the background and t-rex
# Set up a clock to control the frame rate
# Set up the font
# set up the t-rex rectangle
  # with the jumping state and velocity
# Set up the ground y-coordinate
# set up a list to hold obstacles
  #and set up a timer to control obstacle spawning
# Set up the score variable
# define a function to draw the ground
# define a function to draw the t-rex
# define a function to draw the obstacles with for loop
# define a function to display the score
# define the main game loop
  # modify the global variables
  # create a while loop to run the game and call the functions
  # handle events like quitting the game
  # check for key presses to jump
  # create the jump logic for the t-rex
  # create the obstacle logic to move obstacles left
  # remove obstacles that go off screen
  # add new obstacles at random intervals
  # check for collisions between the t-rex and obstacles i.e if they intersect end game loop
  # update the score
  # update the display to show changes
  # control the frame rate to match FPS
